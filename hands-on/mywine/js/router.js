...
define([
  ...
  'collections/wine/Collection'

], function($, StackMob, Util, WineMainView, WineDetailView, WineAddView, SignupView, LoginView, LogoutButtonView,LoginButtonView,Collection) {
  ...
  var initialize = function(){
    ...
    var app_router = new AppRouter({collection: Collection});
